  ...
  export default {
    ...
    data () {
      return {
        ...
        tableInfo: '分类管理',
        // 表标题
        tableTitles: ['商品id', '商品名称', '租赁标题', '商品规格','商品数量','商品图片'],
        // 弹出层标题
        popTitles: {
          'portfolioID':  '商品id',
          'goodsName': '商品名称',
        ...
        operationBtns: [
          ...
          {text: '删除', className: 'small darkGreen', fn: {fnName: 'delete', fnArg: ''}}
        ],
        searchBtns: [
          {text: '查询', className: 'large lightGreen', fn: {fnName: 'query', fnArg: ''}},
          {text: '新增', className: 'large darkGreen', fn: {fnName: 'insert', fnArg: '/leaseAdd.do'}}
        ],
